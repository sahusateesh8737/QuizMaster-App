...
class LiveQuizParticipant(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True, related_name='live_participations')
...
class LiveQuizQuestionResult(models.Model):
    ...
    def update_statistics(self):
        ...
        answers = LiveQuizAnswer.objects.filter(
            participant__session=self.session,
