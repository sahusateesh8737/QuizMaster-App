...
class LeaderboardEntryAdmin(admin.ModelAdmin):
    list_display = ['user', 'quiz', 'rank', 'score', 'percentage', 'is_passed', 'attempt_date']
...
class UserStatisticsAdmin(admin.ModelAdmin):
    list_display = ['user', 'total_quizzes_taken', 'total_quizzes_passed', 'average_score', 'pass_rate']
    list_filter = ['updated_at']
    search_fields = ['user__email']
    readonly_fields = [
        'total_quizzes_taken', 'total_quizzes_passed', 'total_quizzes_failed',
    ...
    fieldsets = (
        ('User', {'fields': ('user',)}),
        ('Quiz Statistics', {
            'fields': ('total_quizzes_taken', 'total_quizzes_passed', 'total_quizzes_failed', 'pass_rate')
        }),
        ('Score Statistics', {
            'fields': ('average_score', 'highest_score', 'lowest_score')
        }),
        ('Question Statistics', {
            'fields': ('total_questions_attempted', 'total_questions_correct', 'accuracy_rate')
        }),
        ('Time & Activity', {
