...
from .models import Category, Question, Quiz, QuizAttempt, UserAnswer
    ...
    try:
        ...
        categories_data = [
            ...
            },
            {
                "name": "Technology",
                "slug": "technology",
                "description": "Computers, Programming, and AI",
                "icon": "Cpu",
            },
            {
                "name": "History",
            ...
            },
            {
                "name": "Arts",
                "slug": "arts",
                "description": "Music, Painting, and Literature",
                "icon": "Palette",
            },
            {
                "name": "Sports",
            ...
            },
            {
                "name": "Entertainment",
                "slug": "entertainment",
                "description": "Movies, TV Shows, and Celebrities",
                "icon": "Film",
            },
        ]
...
class QuizViewSet(viewsets.ModelViewSet):
    ...
    def attempts(self, request, pk=None):
        ...
        active_attempt = QuizAttempt.objects.filter(quiz=quiz, user=request.user, status="in_progress").first()
        ...
        # Create new attempt
        attempt = QuizAttempt.objects.create(quiz=quiz, user=request.user, status="in_progress")
